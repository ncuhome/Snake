...
namespace FallBack
{
  ...
  {
    static bool canFallBack = false;
    public static bool CanFallBack { get => canFallBack; }
    static public FallBackManager Instance = new FallBackManager();
    ...
    {
      //每次弹出的都是尾巴
      if (stack.Count == 1) canFallBack = false;
